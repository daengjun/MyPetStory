...
public class PersonAdapter extends RecyclerView.Adapter<PersonAdapter.ViewHolder> implements ItemTouchHelperListener ,calbacklistener{
    ...
    public void onRightClick(int position, RecyclerView.ViewHolder viewHolder) {
        ...
        Log.d("dangjun", "dangjun friends delete");
    }
